...
class ListingShow extends React.Component {
    ...
    render(){
        ...
        if (listing.reviewIds) {
            reviewLis = listing.reviewIds.map((reviewId) => {
                ...
                <div className="show">
                    <div className="show-info">
                        ...
                        <div className="show-capacity">
                            <div>{listing.capacity} Guests</div>
                            <div>{listing.num_bedroom} bedroom</div>
                            <div>{listing.num_bed} bed</div>
                            <div> {listing.num_bathroom} bath</div>
                        </div>
                    ...
                    <div className="show-checkout">
                        <div className="checkout-top">
                            ...
                            <div className="checkout-review">
                                ...
                                <i className="fas fa-star"></i>
                                <i className="fas fa-star"></i>
                                <span className="num-reviews">487</span>
                            </div>
